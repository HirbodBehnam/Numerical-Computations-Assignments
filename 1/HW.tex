...
\end{align*}
% f := sqrt(x^2+y^3);
% r := 1/6 * (diff(f, x$3) * (1.03-1)^3 + 3 * diff(diff(f, x$2), y$1) * (1.03-1)^2*(1.98-2)^1 + diff(diff(f, x$1), y$2) * (1.03-1)^1*(1.98-2)^2 + diff(f, y$3) * (1.98-2)^3);
% maximize(r, x = 1..1.03, y = 1.98..2);
به کمک نرم افزار
\lr{maple}
